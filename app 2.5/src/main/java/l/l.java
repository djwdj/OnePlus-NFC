...
public class l extends Activity implements OnClickListener,Runnable
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sed1=new StringBuilder(sed1).append(lib).toString();
		sed2=new StringBuilder(sed2).append(lib).toString();
		sed3=new StringBuilder(sed3).append(lib).toString();
		sed4=new StringBuilder(sed4).append(lib).toString();
			...
			case 0:
				switch(v.getId())
				{
					...
					case 21:
						...
						{
							s(rw);
							s(String.format(sed1,2));
							s(String.format(sed2,2));
							s(String.format(sed3,2));
							s(String.format(sed4,2));
					...
					case 22:
						...
						{
							s(rw);
							s(String.format(sed1,1));
							s(String.format(sed2,1));
							s(String.format(sed3,1));
							s(String.format(sed4,1));
